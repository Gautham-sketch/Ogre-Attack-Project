AFRAME.registerComponent("bullets", {
   ...
   removeBullet: function (e) {
      ...
      if (elementHit.id.includes("enemy")) {
        //Add code here
        var countOgre = document.querySelector("#countOgre");
        var OgresFired = parseInt(countOgre.getAttribute("text").value);
        OgresFired -= 1;
        countOgre.setAttribute("text",{
          value : OgresFired
        })
        if(OgresFired === 0){
          let text = document.querySelector("#completed");
